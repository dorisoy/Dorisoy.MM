...
namespace MeetingMinutes.Models
{
    ...
    public partial class meetingminutesEntities : DbContext
    {
        public meetingminutesEntities()
            : base("name=meetingminutesEntities")
        {
        }
        ...
        public virtual DbSet<MeetingInvite> MeetingInvites { get; set; }
